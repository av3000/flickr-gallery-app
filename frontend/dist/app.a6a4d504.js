...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/ImageItem.js":[function(require,module,exports) {
"use strict";
...
},{"./ImageItem":"src/ImageItem.js"}],"src/app.js":[function(require,module,exports) {
"use strict";

var _ImagesList = require("./ImagesList");

console.log("app is connected.");
var imagesList = new _ImagesList.ImagesList('#images-app', '#load-more', '.loading-element');
imagesList.appInit(); // ImagesList.configureInfiniteLoadListener();
},{"./ImagesList":"src/ImagesList.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "43747" + '/');
